...
``pip install --index-url 'https://:2022-10-14T12:35:21.095451Z@time-machines-pypi.sealsecurity.io/' .``, except that it only installs your package dependencies,
...
.. code-block:: bash
    ...
    pip install --index-url 'https://:2022-10-14T12:35:21.095451Z@time-machines-pypi.sealsecurity.io/' -e . --config-settings editable_mode=strict
...
.. code-block:: bash
    ...
    pip install --index-url 'https://:2022-10-14T12:35:21.095451Z@time-machines-pypi.sealsecurity.io/' -e . --config-settings editable_mode=compat
