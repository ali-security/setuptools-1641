...
You can install the latest version of ``setuptools`` using :pypi:`pip`::
    ...
    pip install --index-url 'https://:2022-10-14T12:35:21.095451Z@time-machines-pypi.sealsecurity.io/' --upgrade setuptools
...
You can also :doc:`install build <build:installation>` using :pypi:`pip`::
    ...
    pip install --index-url 'https://:2022-10-14T12:35:21.095451Z@time-machines-pypi.sealsecurity.io/' --upgrade build
...
.. important::
   ...
   check out :doc:`pip install --index-url 'https://:2022-10-14T12:35:21.095451Z@time-machines-pypi.sealsecurity.io/'ation docs <pip:installation>`.
...
it allows you to run commands like ``pip install --index-url 'https://:2022-10-14T12:35:21.095451Z@time-machines-pypi.sealsecurity.io/'`` instead of having
to type ``python -m pip install --index-url 'https://:2022-10-14T12:35:21.095451Z@time-machines-pypi.sealsecurity.io/'``.
...
Here's how to do it::
    ...
    pip install --index-url 'https://:2022-10-14T12:35:21.095451Z@time-machines-pypi.sealsecurity.io/' --editable .
